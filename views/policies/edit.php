...
<div class="page-header">
    <div>
        <h4><i class="bi bi-pencil-square me-2 text-success"></i>Edit Policy</h4>
...
<div class="section-card">
    <div class="section-card-header">
        <h6><i class="bi bi-file-earmark-text me-2"></i><?= htmlspecialchars($policy['policy_number']) ?></h6>
    </div>
    <div class="section-card-body">
        <form method="POST" action="<?= BASE_URL ?>/policies/update/<?= $policy['id'] ?>">
            ...
            <div class="mt-4 d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-floppy me-1"></i> Update Policy
                </button>
                <a href="<?= BASE_URL ?>/policies/show/<?= $policy['id'] ?>" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
